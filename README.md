...
![Pirate English language pack process](https://progress-bar.dev//?title=completed)
...
```
composer require mageplaza/magento-2-pirate-english-language-pack:dev-master mageplaza/module-smtp 
